package com.fclever.config.alipay;
...
public class RefundService {
     ...
     */
    public static Map<String, Object> refund(String tradeNo, String outTradeNo, String refundAmount, String outRequestNo, String refundReason) {
...
//                .setNotifyUrl(notifyUrl) // 没有用
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                log.info("支付宝退款成功");
                msg = "支付宝退款成功!!!";
                tradeNo = result.getResponse().getTradeNo();
                code = 200;
                break;
            case FAILED:
                log.error("支付宝退款失败!!!");
